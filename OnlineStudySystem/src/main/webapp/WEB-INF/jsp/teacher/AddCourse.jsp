...
<script src="<%=basepath%>/static/js/jquery-1.7.2.js" type="text/javascript"></script>
...
<div class="top-bg">
    <div class="container">
        ...
        <div class="user-info">
            <ul>
                <li>
                    <a class="head-portrait head-portrait-s" href="登录.html"></a>
...
<div class="container">
	<div class="kc">
    	<div class="course-title">
        	<h3 class="title"><span>我的课程——课程添加</span></h3>
        </div>

        <form method="post" enctype="multipart/form-data" class="forml" action="/teacher/addCourse?courseId= ${addCo.courseId}"> 

        <div class="cu-info">
            <h4>课程名：          ${addCo.courseName} </h4>
